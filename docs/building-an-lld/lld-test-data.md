...
Test data defined here is referenced in [Lld Test Scenarios](lld-test-scenarios.md) via the data set name. Individual scenarios may apply **specific overrides** on top of the base test data.
...
| Model / Entity | The data model this payload represents — matches a model name from [Lld Data Models](lld-data-models.md) |
...
- [Lld Logical Processing Units](lld-logical-processing-units.md) — Previous section: business logic
- [Lld Test Scenarios](lld-test-scenarios.md) — Next section: test cases that use this data
