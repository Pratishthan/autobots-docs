...
The FBP platform provides pre-built data types for common business concepts. When defining [[lld-data-models|data models]], use these types instead of raw primitives where applicable.
...
- [[lld-data-models]] — Data Models guide that references these types
- [[lld-template]] — LLD template where these types are used
