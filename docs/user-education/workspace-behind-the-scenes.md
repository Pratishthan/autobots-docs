...
This note explains the technical flow that occurs when you [[creating-a-workspace|create a workspace]].
...
3. **LLD changes** — As you work through the [[what-is-an-lld|LLD]] sections, all generated content is committed to this branch
...
- [[what-is-a-workspace]] — Conceptual overview
