...
A Flow defines the **sequence in which [LPUs](lld-logical-processing-units.md) execute** within a [service](lld-services.md). While LPUs are the atomic operations, a Flow stitches them together into an end-to-end processing pipeline.
...
- [Lld Services](lld-services.md) — Previous section: services that use these flows
- [Lld Logical Processing Units](lld-logical-processing-units.md) — The atomic operations stitched together by flows
- [Lld Test Scenarios](lld-test-scenarios.md) — Test scenarios validate the end-to-end flow
