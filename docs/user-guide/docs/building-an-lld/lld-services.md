...
- Define **clear I/O models** — every service should reference data models from the [Data Models](lld-data-models.md) section. Avoid inline field lists
...
- Keep service descriptions **focused on the business outcome**, not the implementation steps — the implementation detail belongs in [LPUs](lld-logical-processing-units.md)
...
- [Lld Data Models](lld-data-models.md) — Previous section: data structures
- [Lld Logical Processing Units](lld-logical-processing-units.md) — Next section: business logic
